            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ftr footer-contact-info">
                        ...
                        <ul class="contact">
                            <li><i class="pe-7s-map"></i> 123 Kigali Nyarugenge,<br> KN 39 KGL</li>
                            <li><i class="pe-7s-call"></i> (+250) 784889732 </li>
                            <li><i class="pe-7s-mail-open"></i> support@example.com </li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <p class="copyright_text">Copyright &copy; 2022 Twariki, All rights Reserved.</p>
                </div>

                <div class="col-lg-6 col-12">
                    <div class="payment_mthd_icon text-end">
                        <img src="img/logo1.png" alt="Card">
                    </div>
                </div>
            </div>
        </div>
